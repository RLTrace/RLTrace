...
type RPCManagerView interface {
	...
	sendProgram(len *int, reply *rpctype.ProgramArgs)
	getCoverage(programs *rpctype.ProgramRes)
}
...
func (serv *RPCServer) GetProgram(a *int, r *rpctype.ProgramArgs) error {
	//send program to client
	serv.mgr.sendProgram(a, r)
	return nil
}

func (serv *RPCServer) SendCoverage(a *rpctype.ProgramRes, r *int) error{
	//send coverage to server
	serv.mgr.getCoverage(a)
	return nil
}
